...
<head>
    ...
    <link href="<c:url value='/ressources/css/productSearch2.css'/>" rel="stylesheet"/>
            ...
            <div class="items-Container">
                ...
                <div class="product-Info">
                    <div class="price-Info">
                        <span class="regular-Price"><span>$</span>${p.value.price}</span>
                    ...
                    <form action="${pageContext.servletContext.getInitParameter('urlPage')}viewProductDetail"  method="post">
                        <div><input id="idProductName" type="hidden" name="idProduct" value="${p.key}"></div>
                        <div><button id="idViewProduct" >View product details</button></div>
                    </form>
